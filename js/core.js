...
window.addEventListener('popstate', function (e) {
    ...
    if (url.indexOf('index') !== -1) {
        document.getElementsByClassName('section-wrapper')[0].classList.add('index');
        document.getElementsByClassName('section-button')[0].classList.add('active');
    } else if (url.indexOf('resume') !== -1) {
        document.getElementsByClassName('section-wrapper')[0].classList.add('resume');
        document.getElementsByClassName('section-button')[1].classList.add('active');
    } else if (url.indexOf('mywork') !== -1) {
        document.getElementsByClassName('section-wrapper')[0].classList.add('mywork');
        document.getElementsByClassName('section-button')[2].classList.add('active');
    } else if (url.indexOf('about') !== -1) {
        document.getElementsByClassName('section-wrapper')[0].classList.add('about');
        document.getElementsByClassName('section-button')[3].classList.add('active');
    }
});
